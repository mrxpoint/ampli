...
export class UserResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Swap], { name: "swaps" })
  @nestAccessControl.UseRoles({
    resource: "Swap",
    action: "read",
    possession: "any",
  ...
  async findSwaps(
    ...
    @graphql.Args() args: SwapFindManyArgs
  ): Promise<Swap[]> {
    const results = await this.service.findSwaps(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Pool], { name: "pools" })
  @nestAccessControl.UseRoles({
    resource: "Pool",
    action: "read",
    possession: "any",
  ...
  async findPools(
    @graphql.Parent() parent: User,
    @graphql.Args() args: PoolFindManyArgs
  ): Promise<Pool[]> {
    const results = await this.service.findPools(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Pair], { name: "pairs" })
  @nestAccessControl.UseRoles({
    resource: "Pair",
    action: "read",
    possession: "any",
  ...
  async findPairs(
    @graphql.Parent() parent: User,
    @graphql.Args() args: PairFindManyArgs
  ): Promise<Pair[]> {
    const results = await this.service.findPairs(parent.id, args);
